...
print(f"BirthYear: {str(birth_year)}")
...
statement_one = (f"{first_name} is a {nationality} {known_for} born in {birth_year}.")
print(statement_one)
...
statement_three = (f"In {year_of_publish} she published the first Algorithm, the {first_algorithm}, at the age of {age_at_passing}.")
