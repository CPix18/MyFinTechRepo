...
c1_combined_expenses = c1_yearly_expenses + c1_yearly_rent

c1_savings = c1_salary - c1_combined_expenses
...
c2_combined_expenses = c2_yearly_rent + c2_yearly_expenses

c2_savings = c2_salary - c2_combined_expenses
